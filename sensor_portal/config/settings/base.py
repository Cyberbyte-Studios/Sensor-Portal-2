...
MIGRATION_MODULES = {
    'sites': 'sensor_portal.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Cameron Chilton""", 'cameron@schilton.tech'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'sensor_portal.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'sensor_portal.users.adapters.SocialAccountAdapter'
